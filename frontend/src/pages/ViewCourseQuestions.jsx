...
const ViewCourseQuestions = () => {
  ...
  const handleQuestionClick = (questionId) => {
    // Navigate to the edit page with the question ID
    navigate('/feedback/courses/edit', { state: { questionId } });
  };
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-[#1F386B] mb-6">View Course Questions</h1>
