...
const EditCourseQuestions = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-[#1F386B] mb-6">Edit Course Questions</h1>
              ...
              {editingId === question.id ? (
                <>
                  <div className="flex-1 mr-2">
                    <label htmlFor={`course-question-${question.id}`} className="block text-[#1F386B] mb-2">
                      Edit Question:
                    </label>
                    <input
                      type="text"
                      id={`course-question-${question.id}`}
                      name="question"
                      value={newQuestion}
